...
@section('css')
    ...
    <style>
        ...
        .cursor-help .bx-info-circle {
            font-size: 0.875rem;
            opacity: 0.7;
            transition: opacity 0.3s ease;
        }

        .cursor-help:hover .bx-info-circle {
            opacity: 1;
        }
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger" onclick="suppRecord()">
...
@section('js')
    ...
    {{-- <script src="/assets/vendor/libs/moment/locale/fr.js"></script> --}}
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var dt_filter = dt_filter_table.DataTable({
                ...
                columnDefs: [{
                    // Suppression de la configuration responsive qui causait le problème
                    /*className: 'control',
                    orderable: false,
            ...
            $('.dt-column-search thead tr:eq(1) th:not(:last)').each(function(i) {
                if (i === 4) { // Index de la colonne updated_at (ajuster si nécessaire)
                    $(this).html(
                        '<div class="input-group input-group-merge">' +
                        '<span class="input-group-text" id="basic-addon-search31"><i class="bx bx-search"></i></span>' +
                        '<input type="date" class="form-control" placeholder="Rechercher" />' +
                        '</div>'
                    );
