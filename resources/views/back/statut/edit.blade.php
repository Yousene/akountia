...
<div class="container-fluid flex-grow-1 container-p-y">
   ...
   @endcan   @can('statut.color.update')
   <div class="col-md-6">
       <label class="form-label" for="color">Couleur</label>
       <input type="text" name="color" id="color" class="form-control" placeholder="Couleur" value="{{ old('color', $record->color) }}" />
       @error('color')
       <span class="helper-text text-danger">{{ $message }}</span>
       @enderror
   </div>
