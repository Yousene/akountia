...
@section('content')
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            ...
            <form class="card-body" method="POST" action="{{ route('category.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row g-3 mt-2">
                    ...
                    @can('category.background_image.create')
                        <div class="col-md-6">
                                ...
                                <div class="d-flex gap-3 align-items-center">
                                    <div class="upload-container">
                                        <input type="file" name="background_image" id="background_image" class="form-control"
                                            accept="image/*" onchange="previewImage(this, 'background_image_preview')" />
                                    </div>
                                    <img id="background_image_preview" src="#" class="rounded"
                                        style="width: 60px; height: 60px; display: none" onerror="this.style.display='none'" />
                                </div>
                    ...
                    @can('category.icon_image.create')
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <div class="d-flex gap-3 align-items-center">
                                    ...
                                    <img id="icon_image_preview" src="#" class="rounded"
                                        style="width: 60px; height: 60px; display: none" onerror="this.style.display='none'" />
                                </div>
                                @error('icon_image')
                                    <span class="helper-text text-danger">{{ $message }}</span>
                    ...
                    @can('category.portrait_image.create')
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <div class="d-flex gap-3 align-items-center">
                                    ...
                                    <img id="portrait_image_preview" src="#" class="rounded"
                                        style="width: 60px; height: 60px; display: none" onerror="this.style.display='none'" />
                                </div>
                ...
                <div class="row g-3">
                    ...
                    @can('category.description.create')
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                    ...
                    @can('category.short_description.create')
                        <div class="col-md-12">
                            <div class="form-group mb-3">
