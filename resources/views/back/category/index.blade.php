                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{ route('category.index') }}">Liste des catégories</a>
                        </li>
                    </ol>
                </nav>
            </div>
                ...
                <table class="dt-column-search table table-bordered border-top">
                    <thead>
                        <tr>
                            ...
                            <th class="text-nowrap"> Description courte </th>
                            <th class="text-nowrap"> Note moyenne </th>
                            <th class="text-nowrap"> Image de la page </th>
                            <th class="text-nowrap"> Image d'accueil </th>
                            <th class="text-nowrap"> Image portrait </th>
