...
@section('title', 'Erreur 405 - Méthode Non Autorisée')
@section('description', 'Méthode non autorisée')
...
@section('content')
    <div class="error-illustration">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 750 500">
            ...
            <g id="freepik--Screwdriver--inject-93">
                <path
            ...
            <g id="freepik--Character--inject-93">
                ...
                <polygon points="304.23 425.1 309.74 434.57 387.31 434.57 392.43 425.1 304.23 425.1" style="fill:#263238">
                </polygon>
                <rect x="158.6" y="173.89" width="371.74" height="238.16" rx="3.27" style="fill:#ebebeb"></rect>
                <polygon points="529.95 412.4 158.21 412.4 158.6 191.69 529.95 191.69 529.95 412.4" style="fill:#fafafa">
                </polygon>
                <path d="M189.84,183.09a3.06,3.06,0,1,1-3.06-3.21A3.14,3.14,0,0,1,189.84,183.09Z" style="fill:#263238">
                </path>
                <path d="M171.28,183.09a3.06,3.06,0,1,1-3.06-3.21A3.14,3.14,0,0,1,171.28,183.09Z" style="fill:#263238">
                </path>
                <path d="M180.82,183.09a3.06,3.06,0,1,1-3.06-3.21A3.14,3.14,0,0,1,180.82,183.09Z" style="fill:#263238">
                </path>
                <path
                ...
                <path
                    ...
                    style="fill:#fff"></path>
                <g style="opacity:0.30000000000000004">
                    <polygon points="370.69 259.26 293.2 307 283.14 324.44 376.16 268.73 370.69 259.26" style="fill:#fff">
                    </polygon>
                </g>
                <g style="opacity:0.30000000000000004">
                ...
                <path
                    ...
                    style="fill:#ff9a6c"></path>
                <path d="M552.1,366.1c.07.43-2.69,1-5.93,1.82s-5.77,2-6,1.59,2.15-2.06,5.6-3S552.05,365.75,552.1,366.1Z"
                    style="fill:#ff9a6c"></path>
                <path
    ...
    <h2 class="mb-2 mx-2">Méthode non autorisée</h2>
    <p class="mb-4 mx-2 error-text">Oops! La méthode utilisée n'est pas autorisée pour cette ressource</p>
@endsection
