...
<body>
                ...
                <div class="app-brand demo">
                    <a href="{{ route('admin') }}" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            @if (pathinfo($apparence->logo, PATHINFO_EXTENSION) == 'svg')
                                <img src="{{ asset($apparence->logo) }}" />
                            @else
                                {{ asset($apparence->logo) }}
                            @endif
                        </span>
                        <span
                            class="app-brand-text demo menu-text fw-bold ms-2 text-truncate">{{ $apparence->label }}</span>
                    </a>
    ...
    <script>
        const route = function(name) {
            const routes = {
                'search.data': '{{ route('search.data') }}',
                'course.edit': function(id) {
                    return '{{ url('/course') }}/' + id + '/edit';
                },
                'category.edit': function(id) {
                    return '{{ url('/category') }}/' + id + '/edit';
                }
            };
